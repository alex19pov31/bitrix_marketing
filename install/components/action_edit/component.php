...
$arResult["FIELDS"]["tab_1"] = array(
	...
	array(
        ...
        "value" => $arResult["DATA"]["PROPERTY_TARGET_VALUE"]
	),
	array(
		"id" => "FAMILY",
		...
		"type" => "list",
        "value" => $arResult["DATA"]["PROPERTY_FAMILY_ENUM_ID"]
	),
	array(
		"id" => "TYPE",
	...
	array(
		...
		"type" => "list",
        "value" => $arResult["DATA"]["PROPERTY_SOURCE_ENUM_ID"]
	),
	array(
		"id" => "STATUS",
		...
		"type" => "list",
        "value" => $arResult["DATA"]["PROPERTY_STATUS_ENUM_ID"]
	),
	array(
		"id" => "RESPONSIBLE",
	...
	array(
		...
		array(
				...
				"type" => "list",
                "value" => $arResult["DATA"]["PROPERTY_TARGETCLIENT_ENUM_ID"]
		),
		array(
				"id" => "COUNTOBJECT",
